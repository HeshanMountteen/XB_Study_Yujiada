    ...
    const config = {
        ...
        module: {
            ...
            loaders: [
                ...
                {
                    test   : /\.less$/,
                    exclude: [helpers.root("./src/css/main.less"),helpers.root("./src/css/reset.less"),helpers.root("./src/css/style.less"),helpers.root("./src/css/normalize.less")],
                ...
                {
                    test   : /\.less/,
                    include: [helpers.root("./src/css/main.less"),helpers.root("./src/css/reset.less"),helpers.root("./src/css/style.less"),helpers.root("./src/css/normalize.less")],
